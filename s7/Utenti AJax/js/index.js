var div = document.querySelector('#bottone')
var btnNU = document.createElement("button")
btnNU.innerHTML = "Nuovo Utente"
div.append(btnNU)
btnNU.addEventListener("click", function() {
btnNU = new URL (location.href="aggiungiUtente.html" )
})
    ...
    .then(data => {
        ...
        data.forEach(element => {
            ...
            btnMod.addEventListener("click", function() {
                btnMod = new URL (location.href="modificaUtente.html?id=" + idChange, target="_blank")
